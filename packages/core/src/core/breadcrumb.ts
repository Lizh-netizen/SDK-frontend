import { BreadcrumbData } from '@webmon/types/src/core/base';
import { BREADCRUMBTYPES, EVENTTYPES } from '@websee/common';
import { _support } from '@websee/utils';
import { InitOptions } from '@webmon/types/src/core/option';
import { getTimestamp, validateOption } from '@webmon/utils/src/core/helpers';
